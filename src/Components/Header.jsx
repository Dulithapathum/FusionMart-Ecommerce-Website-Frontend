  ...
  return (
    ...
    >
      ...
      <div className="flexBetween gap-x-20">
        <Navbar
          conainerStyles={"hidden md:flex gap-x-5 xl:gap-x-10 medium-15"}
        />
        <Navbar
          conainerStyles={`${
            menuOpend
        ...
        <div className="flexBetween gap-x-3 sm:gap-x-8">
          ...
          {!token ? (
            ...
            <div className="group relative ">
              ...
              <ul className="bg-primary shadow-md p-3 w-24 ring-1 rign-slate-900/15 rounded absolute right-0 group-hover:flex flex-col hidden ">
